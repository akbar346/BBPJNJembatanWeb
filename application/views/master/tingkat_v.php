    ...
    <body class="page-container-bg-solid page-sidebar-closed-hide-logo page-header-fixed page-footer-fixed">
                        ...
                        <div class="col-md-12">
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-table"></i>Tabel Data Tingkat
                                    </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="tabelku">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align: center; vertical-align: middle"> Nama Tingkat </th>
                                                    <th style="width: 20%; text-align: center; vertical-align: middle">
                                                        <button id="tambah" data-target="#tambah_tingkat" data-toggle="modal" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Tambah</button>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                    ...
                                    <div id="tambah_tingkat" class="modal fade" tabindex="-1" aria-hidden="true">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                <label class="control-label col-md-3">Nama Tingkat</label>
                                                                                <div class="col-md-8">
                                                                                    <input type="hidden" id="mode_form" name="mode_form" value="Tambah"/>
                                                                                    <input type="hidden" id="id_tingkat" name="id_tingkat"/>
                                                                                    <input type="text" id="nama_tingkat" name="nama_tingkat" class="form-control" placeholder="Masukkan Nama Tingkat" autocomplete="off"/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
        ...
        <script>
                ...
                var InitController = function () {
                    var handleValidation = function () {
                        $('#formku').validate({
                            ...
                            submitHandler: function (form) {
                                $.blockUI();
                                $('#tambah_tingkat').modal('hide');
                                $.ajax({
                                    method: 'POST',
                                    dataType: 'json',
                                    url: '<?= site_url() ?>kerusakan/do_Simpan_Tingkat',
                    ...
                    var handleTable = function () {
                        ...
                        $('#tabelku').dataTable({
                            ...
                            "sServerMethod": "POST",
                            "bRetrieve": true,
                            "sAjaxSource": "<?= site_url() ?>kerusakan/do_Tabel_Tingkat",
                        ...
                        $('body').on('click', '#tabelku_wrapper .btn-editable', function () {
                            ...
                            $.ajax({
                                method: 'POST',
                                dataType: 'json',
                                url: '<?= site_url() ?>kerusakan/do_Ubah_Tingkat',
                                data: {'id_tingkat': $(this).attr("data-id")},
                                success: function (data) {
                                    if (data.success === true) {
                                        $.unblockUI();
                                        span.textContent = "Ubah Tingkat";
                                        $('#mode_form').val(data.results.mode_form);
                                        $('#id_tingkat').val(data.results.id_tingkat);
                                        $('#nama_tingkat').val(data.results.nama_tingkat);
                                        $('#tambah_tingkat').modal('show');
                                    } else {
                                        $.unblockUI();
                                        toastr.warning(data.msgServer);
                                    }
                        ...
                        $('body').on('click', '#tabelku_wrapper .btn-removable', function () {
                            ...
                            bootbox.dialog({
                                message: "Apakah anda yakin menghapus </br>Tingkat : <b>" + name + "</b> ?",
                                    ...
                                    success: {
                                        ...
                                        callback: function () {
                                            ...
                                            $.ajax({
                                                method: 'POST',
                                                dataType: 'json',
                                                url: '<?= site_url() ?>kerusakan/do_Hapus_Tingkat',
                                                data: {'id_tingkat': id},
                                                success: function (data) {
                                                    if (data.success === true) {
                                                        $.unblockUI();
            ...
            function handleClearForm() {
                ...
                span.textContent = "Tambah Tingkat";
