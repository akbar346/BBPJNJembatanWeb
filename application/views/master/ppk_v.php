    ...
    <body class="page-container-bg-solid page-sidebar-closed-hide-logo page-header-fixed page-footer-fixed">
                        ...
                        <div class="col-md-12">
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-table"></i>Tabel Data PPK
                                    </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="tabelku">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 20%; text-align: center; vertical-align: middle"> Kode dan Nama Satker </th>
                                                    <th style="width: 12%; text-align: center; vertical-align: middle"> Kode PPK </th>
                                                    <th style="text-align: center; vertical-align: middle"> Nama PPK </th>
                                                    <th style="text-align: center; vertical-align: middle"> Alamat </th>
                                                    <th style="width: 18%; text-align: center; vertical-align: middle">
                                                        <button id="tambah" data-target="#tambah_ppk" data-toggle="modal" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Tambah</button>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                    ...
                                    <div id="tambah_ppk" class="modal fade" aria-hidden="true">
                                                            ...
                                                            <form class="form-horizontal" action="#" id="formku" name="formku" style="margin-top: 15px">
                                                                <div class="form-body">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                <label class="control-label col-md-3">Kode PPK</label>
                                                                                <div class="col-md-8">
                                                                                    <input type="hidden" id="mode_form" name="mode_form" value="Tambah"/>
                                                                                    <input type="hidden" id="id_ppk" name="id_ppk"/>
                                                                                    <input type="text" id="kode_ppk" name="kode_ppk" class="form-control" placeholder="Masukkan Kode PPK" autocomplete="off" autofocus/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <input type="text" id="nama_ppk" name="nama_ppk" class="form-control" placeholder="Masukkan Nama PPK" autocomplete="off" />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
        ...
        <script>
                ...
                var InitController = function () {
                    var handleValidation = function () {
                        $('#formku').validate({
                            ...
                            submitHandler: function (form) {
                                $.blockUI();
                                $('#tambah_ppk').modal('hide');
                                $.ajax({
                                    method: 'POST',
                                    dataType: 'json',
                                    url: '<?= site_url() ?>master/do_Simpan_Ppk',
                    ...
                    var handleTable = function () {
                        ...
                        $('#tabelku').dataTable({
                            ...
                            "sServerMethod": "POST",
                            "bRetrieve": true,
                            "sAjaxSource": "<?= site_url() ?>master/do_Tabel_Ppk",
                        ...
                        $('body').on('click', '#tabelku_wrapper .btn-editable', function () {
                            ...
                            $.ajax({
                                method: 'POST',
                                dataType: 'json',
                                url: '<?= site_url() ?>master/do_Ubah_Ppk',
                                data: {'id_ppk': $(this).attr("data-id")},
                                success: function (data) {
                                    if (data.success === true) {
                                        $.unblockUI();
                                        span.textContent = "Ubah PPK";
                                        $('#mode_form').val(data.results.mode_form);
                                        $('#id_ppk').val(data.results.id_ppk);
                                        $('#id_satker').select2('val', data.results.id_satker);
                                        $('#kode_ppk').val(data.results.kode_ppk);
                                        $('#nama_ppk').val(data.results.nama_ppk);
                                        $('#alamat').val(data.results.alamat);
                                        $('#no_telp').val(data.results.no_telp);
                                        $('#tambah_ppk').modal('show');
                                    } else {
                                        $.unblockUI();
                                        toastr.warning(data.msgServer);
                                    }
                        ...
                        $('body').on('click', '#tabelku_wrapper .btn-removable', function () {
                            ...
                            bootbox.dialog({
                                message: "Apakah anda yakin menghapus </br>PPK : <b>" + name + "</b> ?",
                                    ...
                                    success: {
                                        ...
                                        callback: function () {
                                            ...
                                            $.ajax({
                                                method: 'POST',
                                                dataType: 'json',
                                                url: '<?= site_url() ?>master/do_Hapus_Ppk',
                                                data: {'id_ppk': id},
                                                success: function (data) {
                                                    if (data.success === true) {
                                                        $.unblockUI();
            ...
            function handleClearForm() {
                ...
                span.textContent = "Tambah PPK";
                $('#mode_form').val('Tambah');
                $('#id_satker').select2('val', '');
            }
        </script>
    </body>
</html>