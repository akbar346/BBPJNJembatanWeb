    ...
    <body class="page-container-bg-solid page-sidebar-closed-hide-logo page-header-fixed page-footer-fixed">
                        ...
                        <div class="col-md-12">
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-table"></i>Tabel Data Jabatan
                                    </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 20%; text-align: center; vertical-align: middle">
                                                        <button id="tambah" data-target="#tambah_jabatan" data-toggle="modal" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Tambah</button>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                    ...
                                    <div id="tambah_jabatan" class="modal fade" tabindex="-1" aria-hidden="true">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    ...
                                                                                    <input type="text" id="nama_jabatan" name="nama_jabatan" class="form-control" placeholder="Masukkan Nama Jabatan" autocomplete="off" autofocus/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
        ...
        <script>
                ...
                var InitController = function () {
                        ...
                        $('#formku').validate({
                            ...
                            submitHandler: function (form) {
                                ...
                                $.ajax({
                                    method: 'POST',
                                    dataType: 'json',
                                    url: '<?= site_url() ?>master/do_Simpan_Jabatan',
                    ...
                    var handleTable = function () {
                        ...
                        $('#tabelku').dataTable({
                            ...
                            "sServerMethod": "POST",
                            "bRetrieve": true,
                            "sAjaxSource": "<?= site_url() ?>master/do_Tabel_Jabatan",
                        ...
                        $('body').on('click', '#tabelku_wrapper .btn-editable', function () {
                            ...
                            $.ajax({
                                method: 'POST',
                                dataType: 'json',
                                url: '<?= site_url() ?>master/do_Ubah_Jabatan',
                                data: {'id_jabatan': $(this).attr("data-id")},
                                success: function (data) {
                                    if (data.success === true) {
                                        $.unblockUI();
                                        span.textContent = "Ubah Jabatan";
                                        $('#mode_form').val(data.results.mode_form);
                                        $('#id_jabatan').val(data.results.id_jabatan);
                                        $('#nama_jabatan').val(data.results.nama_jabatan);
                                        $('#tambah_jabatan').modal('show');
                                    } else {
                                        $.unblockUI();
                                        toastr.warning(data.msgServer);
                                    }
                        ...
                        $('body').on('click', '#tabelku_wrapper .btn-removable', function () {
                            ...
                            bootbox.dialog({
                                message: "Apakah anda yakin menghapus </br>Jabatan : <b>" + name + "</b> ?",
                                    ...
                                    success: {
                                        ...
                                        callback: function () {
                                            ...
                                            $.ajax({
                                                method: 'POST',
                                                dataType: 'json',
                                                url: '<?= site_url() ?>master/do_Hapus_Jabatan',
                                                data: {'id_jabatan': id},
                                                success: function (data) {
                                                    if (data.success === true) {
                                                        $.unblockUI();
            ...
            function handleClearForm() {
                ...
                span.textContent = "Tambah Jabatan";
